...
<body class="bg-gray-50">
    ...
    <script>
        ...
        // Debug session info
        console.log('Session user_id:', <?php echo json_encode($_SESSION['user_id']); ?>);
        console.log('Session role:', <?php echo json_encode($_SESSION['role']); ?>);
        console.log('Session user_name:', <?php echo json_encode($_SESSION['user_name']); ?>);
        ...
        async function loadActiveQueue() {
            try {
                ...
                if (data.success && data.has_active) {
                    ...
                    console.log('Found active queue:', data.queue);
        ...
        function displayActiveQueue(queue) {
            console.log('Displaying active queue:', queue);
            try {
                ...
                console.log('Setting HTML for activeQueue');
                document.getElementById('activeQueue').innerHTML = html;
                console.log('HTML set successfully');
            } catch (error) {
                console.error('Error in displayActiveQueue:', error);
            }
        }
