...
if (isLoggedIn() && ($_SESSION['role'] === 'staff' || $_SESSION['role'] === 'admin')) {
    redirect('index.php');
}
?>
<!DOCTYPE html>
    ...
    <div class="min-h-screen flex items-center justify-center py-12 px-4">
        <div class="max-w-md w-full">
            <div class="text-center mb-8">
                ...
                <p class="mt-2 text-gray-600">Access your dashboard to manage queues</p>
            </div>

            <div class="bg-white rounded-2xl shadow-xl p-8">
                <form id="loginForm" class="space-y-6">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Email or Staff ID</label>
    ...
    <script>
        document.getElementById('loginForm').addEventListener('submit', async (e) => {
            ...
            try {
                ...
                if (data.success && (data.data.user.role === 'staff' || data.data.user.role === 'admin')) {
                    window.location.href = 'index.php';
                } else {
                    alert('Invalid credentials or not authorized as staff');
